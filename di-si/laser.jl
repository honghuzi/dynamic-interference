...
export field, gaussfield, trapzoidalfield, cos2field, GetEleField, GetEnv, ItoE0, nt, dt, t, ele, f1, f2, f3
...
function GetEnv(f::cos2field, t::Float64)
    tStart = f.tm - f.τ /2
    tEnd = f.tm + f.τ /2
    ele = 0.0

    if (t > tStart && t < tEnd)
        ele = cos((t - f.tm) * pi / f.τ )^2
    end
    ele
end
...
τ = 10e-15/2.4189e-17
f1 = cos2field(ItoE0(1e15), 1.6, 0.0, τ, (5)τ/2)
f2 = cos2field(ItoE0(1e15), 1.66, 0.0, τ, (7)τ/2)
f3 = cos2field(ItoE0(1e15), 0.04, 0.0, 6τ, 6τ/2)
